...
<section class="py-12 bg-white border-b border-gray-100 relative z-10">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="w-full bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300 flex items-center justify-center p-2 sm:p-4 text-gray-400 relative overflow-hidden group hover:border-primary/50 transition-colors">
            
            <div class="z-10 flex items-center justify-center w-full">
                <a rel="sponsored" target="_blank" href="https://www.awin1.com/cread.php?s=3795067&v=87121&q=496538&r=2013379" class="flex items-center justify-center w-full">
                    <img src="https://www.awin1.com/cshow.php?s=3795067&v=87121&q=496538&r=2013379" border="0" class="w-full h-auto object-contain mx-auto rounded-lg">
                </a>
            </div>

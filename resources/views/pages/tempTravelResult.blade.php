...
<div class="container mx-auto px-4 py-12 relative z-10 -mt-8">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <div class="flex flex-wrap gap-2 sm:gap-4 items-center justify-between sm:justify-end w-full sm:w-auto">
            ...
            <!-- Favorite Button (Opens Login Modal for guests) -->
            <button onclick="openLoginModal('save_favorites')" class="px-4 py-2 border border-gray-200 bg-white hover:bg-red-50 text-gray-700 hover:text-red-500 rounded-xl transition-colors flex items-center gap-1.5 text-sm font-semibold shadow-sm focus:outline-none">
            ...
            <!-- Visibility Button (Opens Login Modal for guests) -->
            <button onclick="openLoginModal('save_visibility')" class="px-4 py-2 border border-gray-200 bg-gray-50 text-gray-600 hover:bg-gray-100/60 rounded-xl transition-colors flex items-center gap-1.5 text-sm font-semibold shadow-sm focus:outline-none">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" 
                     ...
                     style="display: none;">
                    <button onclick="copyTempItineraryLink()" class="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 hover:text-primary transition-colors text-left">
...
<div id="loginPromptModal" class="hidden" style="position:fixed; inset:0; z-index:99999; display:none; align-items:center; justify-content:center; background:rgba(0,0,0,0.6); backdrop-filter:blur(4px);" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-lg w-full mx-4 animate__animated animate__fadeInUp" style="position:relative; z-index:100000;">
        <div class="px-6 pt-6 pb-4">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900" id="modal-title">Unlock Full Features</h3>
        ...
        <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
            <button type="button" onclick="closeLoginModal()" class="w-full sm:w-auto px-4 py-2 rounded-xl border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                Cancel
            </button>
            <a href="{{ route('loginRegister') }}?redirect={{ urlencode(request()->fullUrl()) }}" class="w-full sm:w-auto px-4 py-2 rounded-xl bg-primary text-white text-sm font-medium text-center hover:bg-primary-dark transition-colors">
                Login / Register
            </a>
        </div>
    </div>
...
<script>
    ...
    function copyTempItineraryLink() {
